        ...
        {  
           ...
           if(($difference -le 0) -and ($difference -gt 1000))
           {
              ...
              $greaterThan1000KB = $True
               Write-Log -Message "PeakworkingSet difference is greater than 1000KB for run $i. Difference after every $sec is: $difference = $pekWorkSetSiz20min - $pekWorkSetSiz" -IsHost -BackgroundColor Red
