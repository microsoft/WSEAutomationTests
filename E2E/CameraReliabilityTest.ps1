...
Set-Variable -Name "WSE_ALL_CAMERA_EFFECTS_SCENARIO_V2"     -Option ReadOnly -Value "AFS+PL+ECT+BBP+CFA"
...
function CameraReliabilityTest {
    ...
    ToggleAIEffectsInSettingsApp -AFVal "On" -AFSVal "True" -AFCVal "True"`
                                 -PLVal "On" `
